python train.py -e shape_table_sweep --grid 16  --epoch 20 -g 5
python train.py -e shape_table_sweep --continue --grid 32 --ckpt best_16  --epoch 20  -g 5
python train.py -e shape_table_sweep --continue --grid 64 --ckpt best_32  --epoch 30  -g 5
