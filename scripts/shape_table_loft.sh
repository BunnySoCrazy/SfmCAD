python train.py -e shape_table_loft --grid 16  --epoch 1 -g 5
python train.py -e shape_table_loft --continue --grid 32 --ckpt best_16  --epoch 1  -g 5
python train.py -e shape_table_loft --continue --grid 64 --ckpt best_32  --epoch 1 -g 5
